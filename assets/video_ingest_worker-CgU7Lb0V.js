...
self.onmessage = async (e) => {
    ...
    if (type === 'INGEST') {
        try {
            ...
            // 3. Lectura por Bloques (Axioma de Streaming Real - v4.66)
            // Ya no usamos file.arrayBuffer() (mortal para 30GB)
            const CHUNK_SIZE = 10 * 1024 * 1024; // 10MB por rebanada
            let offset = 0;
            ...
            while (offset < file.size) {
                ...
                // Pequeño respiro para el hilo del Worker
